...
class Api extends CI_Controller {
	...
	function insert()
	{
		...
		$this->form_validation->set_rules('cellphone', 'Celular', 'required');
		$this->form_validation->set_rules('visit_reason', 'Motivo Visita', 'required');
		...
		else
		{
			$array = array(
				...
				'cellphone_error'		=>	form_error('cellphone'),
				'visit_reason_error'	=>	form_error('visit_reason')
			);
		}
	...
	function fetch_single()
	{
		if($this->input->post('id'))
		{
			...
			foreach($data as $row)
			{
				...
				$output['visit_reason'] = $row['visit_reason'];
			}
